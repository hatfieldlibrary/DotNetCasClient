...
namespace DotNetCasClient
{
    ...
    public sealed class CasAuthentication
    {
            ...
            if (formsAuthenticationTicket != null)
            {
                ...
                else
                {
                    ...
                    if (FormsAuthentication.SlidingExpiration)
                    {
                        ...
                        {
                            SetAuthCookie(newTicket, principal);
                            if (ServiceTicketManager != null)
                            {
        ...
        /// <summary>
        /// Adds Response header to the original SetAuthCookie.
        /// </summary>
        /// <param name="clientTicket">The FormsAuthenticationTicket to encode</param>
        /// <param name="principal">The ICasPrincipal with the Assertion.PrincipalName to add in headers</param>
        public static void SetAuthCookie(FormsAuthenticationTicket clientTicket, ICasPrincipal principal)
        {
            Initialize();
            HttpContext current = HttpContext.Current;
            ...
            current.Response.Headers.Add("CASUser", principal.Assertion.PrincipalName);
            current.Response.Cookies.Add(GetAuthCookie(clientTicket));
        }
